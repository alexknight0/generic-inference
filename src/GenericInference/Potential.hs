...
module GenericInference.Potential (
...
import qualified GenericInference.IndexedSet       as S
import qualified GenericInference.Utils            as A (listArray0)
import qualified GenericInference.Utils            as M (unionA, unsafeLookup)
import qualified GenericInference.Utils            as U
import           GenericInference.ValuationAlgebra (Binary, Generic, NFData)

...
module GenericInference.Inference (
      query
    , unsafeQuery
    , queryDrawGraph
    , queries
...
import qualified GenericInference.Inference.MessagePassing.Distributed as D (SerializableValuation)
import qualified GenericInference.Inference.ShenoyShafer               as SS (queries)
import           GenericInference.ValuationAlgebra

import qualified Data.Set                                              as S
import qualified GenericInference.Inference.DynamicProgramming         as D
import qualified GenericInference.Inference.Fusion                     as F
...
import qualified GenericInference.Inference.Statistics                 as S hiding
                                                                            (empty)

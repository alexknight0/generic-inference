...
module GenericInference.Inference.JoinTree.Tree (
...
import           GenericInference.ValuationAlgebra  hiding (frameLength)
...
import qualified GenericInference.Utils             as L (count)

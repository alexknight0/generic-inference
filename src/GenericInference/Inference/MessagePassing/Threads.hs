...
module GenericInference.Inference.MessagePassing.Threads (
      messagePassing
    , messagePassing'
    , collectAndCalculate
) where
...
import qualified GenericInference.Inference.JoinTree        as JT
import qualified GenericInference.Inference.JoinTree.Forest as JT hiding
                                                                  (unsafeUpdateValuations,
                                                                   vertexList)
import qualified GenericInference.Inference.JoinTree.Tree   as JT
import qualified GenericInference.Utils                     as M (filterKeys)

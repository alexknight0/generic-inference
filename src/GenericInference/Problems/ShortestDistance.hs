...
import qualified GenericInference.LabelledMatrix                      as M
import qualified GenericInference.ValuationAlgebra.QuasiRegular       as Q (SemiringValue,
...
import qualified GenericInference.Graph.Undirected                    as UG
import qualified GenericInference.Inference                           as I
import qualified GenericInference.Inference.EliminationSequence       as E
...
import qualified GenericInference.ValuationAlgebra.QuasiRegular.Value as Q (TropicalSemiringValue (..),
                                                                            toDouble)

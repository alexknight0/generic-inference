...
module GenericInference.Problems.BayesianNetwork
...
import qualified GenericInference.Utils                      as M (fromListA)
...
getProbability mode s qs network' = do
    results <- fromRight $ I.queriesWithStats s mode network' domains
